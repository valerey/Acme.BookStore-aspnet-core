...
namespace Acme.BookStore.Permissions
{
    public class BookStorePermissionDefinitionProvider : PermissionDefinitionProvider
    {
        public override void Define(IPermissionDefinitionContext context)
        {
            ...
            var shelvesPermission = bookStoreGroup.AddPermission(BookStorePermissions.Shelves.Default, L("Permission:Shelves"));
            shelvesPermission.AddChild(BookStorePermissions.Shelves.Create, L("Permission:Authors.Create"));
            shelvesPermission.AddChild(BookStorePermissions.Shelves.Edit, L("Permission:Authors.Edit"));
            shelvesPermission.AddChild(BookStorePermissions.Shelves.Delete, L("Permission:Authors.Delete"));
        }
